    ...
    return (
      <div className="mb-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-neutral-900/50 border border-white/5 rounded-2xl h-[424px] p-5 animate-pulse">
  ...
  return (
    <div className="mb-12">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Middle Column - Merged Market Activity */}
        <div className="bg-neutral-900/50 border border-white/5 rounded-2xl overflow-hidden flex flex-col h-[424px]">
        ...
        <div className="bg-[#111119] border border-white/5 rounded-2xl p-6 h-[424px] flex flex-col relative overflow-hidden group">
